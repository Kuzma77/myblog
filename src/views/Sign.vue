		...
		<div class="login-box">
			...
			<div class="tab-box" v-if="show && selected === 0">
				...
				<div class="code-box">
					...
					<div class="img"><img ref="codeImg" @click="refresh()" style="cursor: pointer; width: 120px;height: 50px;" /></div>
				</div>
...
.full {
	...
	background-image: url('https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2745649517,3968788549&fm=26&gp=0.jpg');
	/* 图片全屏 */
